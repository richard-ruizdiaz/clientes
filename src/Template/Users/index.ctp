    	...
    	<div class="table-responsive">
    		...
    		<tr>
                ...
                <td>
                    ...
                    <?= $this->Html->link('Editar contraseña', ['action' => 'edit2', $user->id], ['class' => 'btn btn-sm btn-primary']) ?>
                    <?= $this->Form->postLink('Eliminar', ['action' => 'delete', $user->id], ['confirm' => 'Eliminar usuario ?', 'class' => 'btn btn-sm btn-danger']) ?>

                    <?= $this->Form->postLink('ACTIVAR', ['action' => 'activar', $user->id], ['confirm' => 'Desea activar usuario ?', 'class' => 'btn btn-sm btn-danger']) ?>
                    <?= $this->Form->postLink('DESACTIVA', ['action' => 'desactivar', $user->id], ['confirm' => 'Desea desactivar usuario ?', 'class' => 'btn btn-sm btn-danger']) ?>
